...
#create instance as a global var
bootstrap = Bootstrap()
db = SQLAlchemy()
moment = Moment()
pagedown = PageDown()
...
def create_app(config_name):                #creating app in function
    app = Flask(__name__)
    app.config.from_object(confi[config_name])
    ...
    from .talks import talks as talks_blueprint         #prefix-ing all routes defined in bprint as /auth
    ...
    from app.email import start_email_thread
